            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#">Alege-ți mâncarea favorită</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active" ><span>3</span><a href="checkout.php">Comandă și plătește</a></li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        <td>Valoarea totală</td>
                                                        <td> <?php echo "Lei ".$item_total; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Pregătire și expediere</td>
                                                        <td>Livrare gratuită</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-color"><strong>Total</strong></td>
                                                        <td class="text-color"><strong> <?php echo "Lei ".$item_total; ?></strong></td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="payment-option">
                                        <ul class=" list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Plata la livrare</span>
                                        ...
                                        <p class="text-xs-center"> <input type="submit" onclick="return confirm('Are you sure?');" name="submit"  class="btn btn-outline-success btn-block" value="Comandă acum"> </p>
                                    </div>
									</form>
                                </div>
                            </div>
