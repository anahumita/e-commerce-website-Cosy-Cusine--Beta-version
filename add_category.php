...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="images/logo_nou.png" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src="images/Logo_scris.PNG" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/20.jpg" alt="user" class="profile-pic" /></a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false">  <span><i class="fa fa-user f-s-20 "></i></span><span class="hide-menu">Utilizatori</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add_users.php">Adaugă utilizator </a></li>
								
                               
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Magazine</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allrestraunt.php">Toate magazinele</a></li>
								<li><a href="add_category.php"> Adaugă categorie</a></li>
                                <li><a href="add_restraunt.php">Adaugă restaurant</a></li>
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Meniu</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add_menu.php">Adaugă meniu</a></li>
						 ...
						 <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="hide-menu">Comenzi</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_orders.php">Toate comenziile</a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Adaugă categorie restaurant</h4>
                            </div>
                            <div class="card-body">
					   ...
					   <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Listă categorii</h4>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © COSY Cusine All rights reserved. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
