...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/main_2.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Cosy cuisine </h1>
                    <h5 class="font-white space-xs">Găsiți gratuit restaurante, oferte speciale și cupoane</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">Încearcă și bucură-te!</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="Încearcă și bucură-te!"> </div>
                            </div>
                            <button onclick="location.href='restaurants.html'" type="button" class="btn theme-btn btn-lg">Caută mâncare</button>
                        </form>
                    </div>
                    <div class="steps">
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Delectările Lunii: Arome Excepționale pentru Gusturi Fine!</h2>
                    <p class="lead">Cel mai simplu mod de a ajunge la mâncarea ta preferată.</p>
                </div>
                <div class="row">
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Adaugă în coș</a> </div>
															</div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>Comandă în 3 pași simpli</h2>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Alege un restaurant</h3>
                                    <p>Avem tot ce îți trebuie cu meniuri de la peste 345 de restaurante de livrare online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Alege o mâncare delicioasă</h3>
                                <p>Avem tot ce îți trebuie cu meniuri de la peste 345 de restaurante de livrare online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Alege ridicarea sau livrarea la domiciliu</h3>
                                <p>Bucură-te de comanda ta livrată direct la ușa ta! Plătește online sau la livrare.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Plătește la livrare</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Restaurante recomandate</h4> </div>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/takeaway.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
